...
KERNEL_OPTIONS  = -DVIDEO_MODE=3 -DINTRO_LOGO=0 -DRESOLUTION_EXT=1 -DVRAM_TILES_H=32
KERNEL_OPTIONS +=  -DSCROLLING=0 -DMAX_SPRITES=14 -DRAM_TILES_COUNT=32 -DTRANSLUCENT_COLOR=0x00
